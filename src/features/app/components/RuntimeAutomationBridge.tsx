...
export const RuntimeAutomationBridge = memo(function RuntimeAutomationBridge({
  ...
  useEffect(() => {
    ...
    automationController.setPromptEnabled,
    automationController.setPromptSourceName,
    automationController.setPromptText,
    automationController.setAutomationEnabled,
    automationController.summary,
    onControllerChange,
    runtime.automation.enabled,
    runtime.automation.promptEnabled,
    runtime.automation.promptSourceName,
    runtime.automation.promptText,
